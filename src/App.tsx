...
const tools = [
  ...
  {
    name: "Mermaid Viewer",
    description: "Paste Mermaid diagrams and explore with pan & zoom. Fast, simple, no-frills viewer.",
    href: "/mermaid-viewer",
    icon: (
      <svg
        className="w-6 h-6"
  ...
  },
  {
    ...
    description: "Assemble Anthropic API SSE stream events into a unified JSON message.",
